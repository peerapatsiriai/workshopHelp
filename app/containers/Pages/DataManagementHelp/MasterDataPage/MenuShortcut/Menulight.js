  ...
  return (
    <Box
      sx={{
        ...
        background: 'white',
        borderRadius: 8,
        px: onlyLargeScreen ? 0 : onlyMediumScreen ? 0 : onlySmallScreen ? 6 : 6,
    ...
    >
      ...
      >
        <Box sx={{ width: '100%', height: '50%' }}>
          <Box sx={{ m: 2, ml: 0.5, display: 'flex', flexDirection: 'row', justifyContent: 'space-around' }}>
            <Box sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
              <Box sx={{ mt: 0.5, ml: 2, mr: 1, width: 50, background: 'lightgray', borderRadius: 2.5 }}>
        ...
        <Box sx={{ width: '100%', height: '50%' }}>
          ...
          >
            <Typography sx={{ fontSize: countTableFontSize, fontWeight: 'bold' }}>{countTable} Tables</Typography>
