...
function AcademicsPage() {
  ...
  const handleInsertFacultySubmit = (e) => {
    e.preventDefault();
    axios
      .post('http://192.168.1.168:8000/api/method/frappe.help-api.insertfaculty', startFaculty)
      .then((res) => {
        console.log(res);
        setOpenInsFac(false);
  ...
  const hendleEditFacultySubmit = () => {
    axios
      .post('http://192.168.1.168:8000/api/method/frappe.help-api.editfaculty', startFaculty)
      .then((res) => {
        console.log(res);
        setOpenUpdFac(false);
  ...
  const handleDeleteFacultySubmit = () => {
    axios
      .post('http://192.168.1.168:8000/api/method/frappe.help-api.delete', deleteFaculty)
      .then((res) => {
        console.log(res);
